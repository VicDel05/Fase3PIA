...
<body>
    ...
    <nav class="navbar navbar-expand-lg barraNav">
        <div class="container-fluid">
          <a class="navbar-brand" href="/miembroindex"><img src="img/QC-logo.png" alt="logo" width="75px" class="rounded"></a>
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              <li class="nav-item">
                <a class="nav-link" aria-current="page" href="/acercadeM">Acerca de</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="/productoM">Productos</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="/contactanosM">Contacto</a>
              </li>
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                  <li><a class="dropdown-item" href="/cuenta"><img src="img/usuario.png" alt="" class="img-fluid imglogout">Mi cuenta</a></li>
                  <li><a class="dropdown-item" href="/"><img src="img/cerrar-sesion.png" alt="" class="img-fluid imglogout">Cerrar sesión</a></li>
                </ul>
              </li> -->
            </ul>
